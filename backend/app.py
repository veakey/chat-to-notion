...
def process_chat():
    ...
    try:
        ...
        # Diviser le contenu en chunks de 2000 caractères maximum (limite Notion)
        content_chunks = split_content_into_chunks(parsed_data['content'], max_length=2000)
        
        # Créer les blocs children avec un bloc par chunk
        children = []
